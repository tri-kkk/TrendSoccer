                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TeamProductionSection(
                              runs: GaugeData(label: '득점', homeRatio: data.runsRatio),
                              runsAllowed: GaugeData(label: '실점', homeRatio: data.runsAllowedRatio),
                              hits: GaugeData(label: '안타', homeRatio: data.hitsRatio),
                            ),
                            const SizedBox(height: TsSpacing.xl),
                            SeasonTeamStatsSection(
                              avg: GaugeData(label: 'AVG', homeRatio: data.avgRatio),
                              ops: GaugeData(label: 'OPS', homeRatio: data.opsRatio),
                              era: GaugeData(label: 'ERA', homeRatio: data.eraRatio),
                              whip: GaugeData(label: 'WHIP', homeRatio: data.whipRatio),
                            ),
                            const SizedBox(height: TsSpacing.xl),
                          ],
                        ),
