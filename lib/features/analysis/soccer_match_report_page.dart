...
class _SoccerMatchReportPageState extends ConsumerState<SoccerMatchReportPage> {
  ...
  Widget _buildMissingHeaderError() {
    ...
    return KeyedSubtree(
      ...
      key: const ValueKey<Object>('soccer_report_missing_header'),

      child: Padding(

        padding: const EdgeInsets.all(TsSpacing.lg),

        child: const _MissingHeaderState(),
  ...
  Widget _buildStandardTab(SoccerAnalysisParams params) {

    final analysisAsync = ref.watch(soccerAnalysisProvider(params));

    final planType = ref.watch(authProvider).planType;

    final matchTimestamp =

        widget.initialHeader?.matchTimestamp ?? widget.matchTimestampUtc;
    ...
    return analysisAsync.when(
      ...
      error: (error, stackTrace) => KeyedSubtree(
        ...
        child: Padding(
          ...
          child: SoccerStandardTabError(
            ...
            onRetry: () => ref.invalidate(soccerAnalysisProvider(params)),
      ...
      data: (raw) {
        ...
        final markdown = raw['analysis']?.toString().trim() ?? '';
        ...
        return KeyedSubtree(
          ...
          child: Padding(
            ...
            child: SoccerStandardMarkdownTabHost(

              markdown: markdown,

              planType: planType,

              matchTimestampUtc: matchTimestamp,
